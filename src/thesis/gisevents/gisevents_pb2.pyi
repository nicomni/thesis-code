...
class ModificationEvent(_message.Message):
    __slots__ = ("id", "timestamp", "version", "point_patch", "linestring_patch", "prop_patch")
    ID_FIELD_NUMBER: _ClassVar[int]
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[int] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., version: _Optional[int] = ..., point_patch: _Optional[_Union[Point, _Mapping]] = ..., linestring_patch: _Optional[_Union[LineStringPatch, _Mapping]] = ..., prop_patch: _Optional[_Union[PropPatch, _Mapping]] = ...) -> None: ...
